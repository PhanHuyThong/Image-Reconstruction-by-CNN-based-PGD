...
%                               then focus on a small interval around it, with 4 mesh points
...
%                     the target, to calculate RSNR
%
%             gamma0: numeric vector, initial learning rate of RPGD
%             H     : function, the H operator defined in main.m
%             Ht    : function, the HT operator defined in main.m
%             
%         Output:
%             best_snr : type Float, RSNR of the best reconstruction 
%             rec : type torch.tensor, the best reconstruction          
